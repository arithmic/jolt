    ...
    ProofTranscript: Transcript,
{
    ...
    pub primary_sumcheck: PrimarySumcheck<F, ProofTranscript>,
...
pub struct PrimarySumcheck<F: JoltField, ProofTranscript: Transcript> {
    ...
    pub openings: PrimarySumcheckOpenings<F>,
