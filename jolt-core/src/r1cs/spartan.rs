...
// #[derive(Debug)]
// pub struct SpartanWitness<'a, F:JoltField> {
//     pub z_step: Vec<&'a MultilinearPolynomial<F>>,
// }
...
//     pub func: Box<
//         dyn Fn(JoltStuff<MultilinearPolynomial<F>>) -> SpartanWitness<'a, F>
//             + 'a,
//     >,
// }
...
//     ) -> Self {
//         let polynomial_stream = (|shard: JoltStuff<MultilinearPolynomial<F>>| SpartanWitness::<F> {
//             z_step: I::flatten::<C>()
//                 .iter()
//                 .map(move |var| var.get_ref(&shard))
//                 .collect(),
//         });
