...
pub fn convert_from_inst_lookups_proof_to_circom(inst_lookup_proof: InstructionLookupsProof<{C}, {M}, Scalar, HyperKZG<Bn254, PoseidonTranscript<Fp, Scalar>>, RV32I, RV32ISubtables<Scalar> ,PoseidonTranscript<Fp, Scalar>>) -> InstructionLookupsProofCircom{
