...
pub fn convert_from_inst_lookups_proof_to_circom(inst_lookup_proof: InstructionLookupsProof<{C}, {M}, Scalar, HyperKZG<Bn254, PoseidonTranscript<Scalar, Fp>>, RV32I, RV32ISubtables<Scalar> ,PoseidonTranscript<Scalar, Fp>>) -> InstructionLookupsProofCircom{
