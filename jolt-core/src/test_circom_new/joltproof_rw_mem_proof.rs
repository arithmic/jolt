...
use crate::{jolt::vm::{bytecode::BytecodeProof, read_write_memory::ReadWriteMemoryProof}, lasso::memory_checking::MultisetHashes, poly::{commitment::hyperkzg::HyperKZG, unipoly::UniPoly}, subprotocols::grand_product::BatchedGrandProductProof, utils::poseidon_transcript::PoseidonTranscript};
...
pub fn convert_from_read_write_mem_proof_to_circom(rw_mem_proof: ReadWriteMemoryProof<Scalar, HyperKZG<Bn254, PoseidonTranscript<Scalar, Fp>>, PoseidonTranscript<Scalar, Fp>>) -> ReadWriteMemoryProofCircom
{
