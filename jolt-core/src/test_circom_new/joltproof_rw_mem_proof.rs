...
pub fn convert_from_read_write_mem_proof_to_circom(rw_mem_proof: ReadWriteMemoryProof<Scalar, HyperKZG<Bn254, PoseidonTranscript<Fp, Scalar>>, PoseidonTranscript<Fp, Scalar>>) -> ReadWriteMemoryProofCircom
{
