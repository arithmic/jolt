...
pub fn compute_uniform_spartan_to_circom(uni_spartan_proof: UniformSpartanProof<C, JoltR1CSInputs, Scalar, PoseidonTranscript<Fp, Scalar>>) -> UniformSpartanProofCircom {
