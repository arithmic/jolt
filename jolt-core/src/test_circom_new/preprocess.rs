...
pub fn convert_joltpreprocessing_to_circom(jolt_preprocessing: JoltPreprocessing<C, Scalar, HyperKZG<Bn254, PoseidonTranscript<Fp, Scalar>>,PoseidonTranscript<Fp, Scalar>>) -> JoltPreprocessingCircom{
