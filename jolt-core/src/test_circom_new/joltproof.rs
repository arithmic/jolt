...
pub fn convert_jolt_proof_to_circom(proof: JoltProof<{C}, {M}, JoltR1CSInputs, Scalar, HyperKZG<Bn254, PoseidonTranscript<Scalar, Fp>>, RV32I, RV32ISubtables<Scalar>, PoseidonTranscript<Scalar, Fp>>) -> JoltproofCircom{
