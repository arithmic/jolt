...
pub fn convert_jolt_proof_to_circom(proof: JoltProof<{C}, {M}, JoltR1CSInputs, Scalar, HyperKZG<Bn254, PoseidonTranscript<Fp, Scalar>>, RV32I, RV32ISubtables<Scalar>, PoseidonTranscript<Fp, Scalar>>) -> JoltproofCircom{
