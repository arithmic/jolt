...
pub fn convert_from_batched_GKRProof_to_circom_hyrax(proof: &BatchedGrandProductProof<HyraxScheme<Projective, PoseidonTranscript<Fp>>, PoseidonTranscript<Fp>>) -> BatchedGrandProductProofCircom
{
