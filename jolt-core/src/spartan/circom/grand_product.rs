...
pub fn convert_from_batched_GKRProof_to_circom_hyrax(proof: &BatchedGrandProductProof<HyraxScheme<G1Projective, PoseidonTranscript<Fp>>, PoseidonTranscript<Fp>>) -> BatchedGrandProductProofCircom
{
    let num_gkr_layers = proof.gkr_layers.len();
