...
use jolt_core::{field::JoltField, msm::{CurveGroupConfig, Icicle, VariableBaseMSM}, poly::dense_mlpoly::DensePolynomial};
...
fn bench_msm<G: CurveGroup + Icicle>(input: (Vec<G>, Vec<G::ScalarField>)) -> G {
